      ...
      <div className="flex flex-col items-center justify-center w-screen h-screen space-y-8 font-medium bg-white selection:bg-black selection:text-white">
        <div className="p-8 space-y-8 shadow-2xl rounded-3xl">
          ...
          <div className="space-y-2">
            ...
            <input
              className="w-full p-2 ring-2 ring-black rounded-xl"
              type="text"
              ref={textInput}
              id="textInput"
              onChange={() =>
                textInput !== null &&
                setNotificationText(textInput.current.value)
              }
            ...
            <RadioGroup value={pos} onChange={setPos} className="">
              <div className="flex items-center w-full justify-evenly">
                <RadioGroup.Option value="top-left" as={Fragment}>
                  {({ checked }) => (
                    <button
                      className={`px-6 py-1 rounded-lg select-none ring-2 ring-black hover:scale-95 duration-300 ${
          ...
          <div className="space-y-2">
            ...
            >
              <RadioGroup.Option value="success" as={Fragment}>
                {({ checked }) => (
                  <button
                    className={`px-4 py-1 rounded-lg select-none ring-2 ring-black hover:scale-95 duration-300 ${
                      checked && "bg-black text-white"
                    }`}
                  >
                    Success
          ...
          <motion.button
            ...
            className="flex items-center px-10 py-4 space-x-2 font-black text-white bg-black shadow-xl rounded-2xl"
            onClick={notify}
          >
            <motion.div
              variants={{
                hover: { rotate: 23, scale: 0.9 },
                tapped: { rotate: -23 },
                initial: { rotate: 0 },
              }}
            >
